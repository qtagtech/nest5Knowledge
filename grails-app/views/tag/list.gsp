			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="keywords" title="${message(code: 'tag.keywords.label', default: 'Keywords')}" />
				...
				<g:each in="${tagInstanceList}" status="i" var="tagInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${tagInstance.id}">${fieldValue(bean: tagInstance, field: "keywords")}</g:link></td>
