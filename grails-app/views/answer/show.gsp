	...
	<body>
		...
		<div id="show-answer" class="content scaffold-show" role="main">
			...
			<ol class="property-list answer">
				...
				<g:if test="${answerInstance?.rating}">
				<li class="fieldcontain">
					<span id="rating-label" class="property-label"><g:message code="answer.rating.label" default="Rating" /></span>
					
						<span class="property-value" aria-labelledby="rating-label"><g:fieldValue bean="${answerInstance}" field="rating"/></span>
