			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="icon" title="${message(code: 'type.icon.label', default: 'Icon')}" />
				...
				<g:each in="${typeInstanceList}" status="i" var="typeInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${typeInstance.id}">${fieldValue(bean: typeInstance, field: "icon")}</g:link></td>
